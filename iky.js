...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6283146208804`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
...
🐟 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created ℎ𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧☕`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
 ...
 ℎ𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
*「 ℎ𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧☕︎ 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Mendaftar Di herman bot🐟*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 Herman Broadcast 」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
//------------------< Lainnya >-------------------
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://i.ibb.co/VQpsygG/20211028-63818.jpg'
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              ikyy.sendMessage('6283146208804@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              ikyy.sendMessage('6283146208804@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatrava':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT RAVA DONE')
              ikyy.sendMessage('6283146208804@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://instagram.com/cal_me_herman?utm_medium=copy_link`)
             break
      case 'hamdeh':
             reply('Hamdeh hamdeh')
             break
